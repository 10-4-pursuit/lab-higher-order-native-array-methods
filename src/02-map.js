...
function getSongTitles(songs) {
  // Using the map method to extract and return an array of song titles
...
function getSongDetails(songs) {
  // Using the map method to create an array of formatted strings
...
function getTitleAndArtist(songs) {
  // Using the map method to create an array of objects with title and artist properties
